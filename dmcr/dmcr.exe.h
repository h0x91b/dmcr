...
typedef struct Building Building, *PBuilding;
...
struct S1_AI {
    undefined field_0x0[269];
    ushort field_0x10d;
    undefined field_0x10f[114];
    undefined1 startRes;
    byte resOnMap;
    byte difficulty;
    undefined1 landType; /* Created by retype action */
    undefined field_0x185[3523];
    byte FieldExist;
    undefined field_0xf49;
    undefined field_0xf4a;
    undefined field_0xf4b;
    bool DefenseState;
    undefined field_0xf4d[54192];
    undefined1 SetUpgradeLock[8]; /* Created by retype action */
    undefined field_0xe305[39];
    undefined4 field_0xe32c;
    undefined4 field_0xe330;
    undefined2 field_0xe334;
    undefined2 field_0xe336;
    undefined field_0xe338[4127];
    undefined2 field_0xf357;
    undefined field_0xf359[8190];
    undefined2 upgrades;
};

typedef struct Unit Unit, *PUnit;

typedef struct Unit2 Unit2, *PUnit2;
